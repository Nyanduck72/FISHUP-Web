  ...
  <div className="px-6 py-12 text-center md:px-12 lg:text-left">
        ...
        <div className="mb-12 2xs:mt-22 xs:mt-2 sm:mt-10 md:mt-10 lg:mt-0 lg:mb-0">
          <div
            ...
            <a className="inline-block rounded px-12 pt-4 pb-3.5 text-sm font-medium uppercase leading-normal text-primary transition duration-150 ease-in-out hover:bg-neutral-500 hover:bg-opacity-10 hover:text-primary-600 focus:text-primary-600 focus:outline-none focus:ring-0 active:text-primary-700 dark:hover:bg-neutral-700 dark:hover:bg-opacity-40"
              data-te-ripple-init data-te-ripple-color="light" href="#elements" role="button">Learn more</a>
          </div>
        </div>
        ...
        <div className="items-center max-w-screen-xl px-4 py-8 mx-auto lg:grid lg:grid-cols-4 lg:gap-16 xl:gap-24 lg:py-24 lg:px-6">
            <div className="col-span-2 mb-8">
                ...
                <div className="pt-6 mt-6 space-y-4 border-t border-gray-200 dark:border-gray-700">
                    <div>
                      <a href="#" className="inline-flex items-center text-base font-medium text-emerald-600 hover:text-emerald-600 dark:text-emerald-400 dark:hover:text-emerald-600">
                        Descarga la app
    ...
    <section className="bg-white dark:bg-neutral-800" id='pricing'>
      ...
      <section className="bg-white dark:bg-neutral-700" id='team'>
        <div className="max-w-screen-xl px-4 py-8 mx-auto lg:py-24 lg:px-6">
            <div className="max-w-screen-md mx-auto mb-8 text-center lg:mb-12">
                <h2 className="mb-4 text-3xl font-extrabold tracking-tight text-gray-900 dark:text-white">Meet the Team</h2>
                <p className="mb-5 font-light text-gray-500 sm:text-xl dark:text-gray-400">Hello!, we're the guys behind <span className='text-emerald-600 font-bold'>FISHUP</span></p>
                <div className="grid mt-5 items-center gap-10 sm:grid-cols-1 md:grid-cols-3">
                    <div className="flex flex-col items-center mb-8 bg-neutral-600 p-8 rounded">
                        <img src="" alt="profile picture" className="w-24 h-24 rounded-full" />
                        <h3 className="mt-4 mb-2 text-xl font-bold dark:text-white">Marco Antonio Duarte Corona</h3>
                        <p className="text-gray-500 dark:text-gray-400"></p>
                    </div>
                    <div className="flex flex-col items-center mb-8 bg-neutral-600 p-8 rounded">
                        <img src="" alt="profile picture" className="w-24 h-24 rounded-full" />
                        <h3 className="mt-4 mb-2 text-xl font-bold dark:text-white">Jesús Alejandro González Luján</h3>
                        <p className="text-gray-500 dark:text-gray-400">CEO</p>
                    </div>
                    <div className="flex flex-col items-center mb-8 bg-neutral-600 p-8 rounded">
                        <img src="" alt="profile picture" className="w-24 h-24 rounded-full" />
                        <h3 className="mt-4 mb-2 text-xl font-bold dark:text-white">Carlos Abraham Jiménez Carrera</h3>
                        <p className="text-gray-500 dark:text-gray-400">Especialista en Electrónica y Bases de Datos</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section className="bg-gray-50 dark:bg-gray-800">
        <div className="max-w-screen-xl px-4 py-8 mx-auto lg:py-16 lg:px-6">
            <div className="max-w-screen-sm mx-auto text-center">
                <h2 className="mb-4 text-3xl font-extrabold leading-tight tracking-tight text-gray-900 dark:text-white">Descarga la App</h2>
                <p className="mb-6 font-light text-gray-500 dark:text-gray-400 md:text-lg">Obtén la aplicación aquí</p>
                <a href="#" className="text-white bg-emerald-600 hover:bg-emerald-600 focus:ring-4 focus:ring-emerald-600 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-emerald-600 dark:hover:bg-emerald-600 focus:outline-none dark:focus:ring-emerald-600">D E S C A R G A</a>
            </div>
        </div>
    </section>
